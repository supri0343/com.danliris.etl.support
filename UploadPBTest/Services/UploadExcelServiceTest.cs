...
using UploadPB.Services.Class.PostBC23;
...
namespace UploadPBTest.Services
{
    public class UploadExcelServiceTest
    {
        ...
        private SupportDbContext _dbContext()
        {
            DbContextOptionsBuilder<SupportDbContext> optionsBuilder = new DbContextOptionsBuilder<SupportDbContext>();
            

            SupportDbContext dbContext = new SupportDbContext(optionsBuilder.Options);
        ...
        //    UploadExcelService uploadExcelService = new UploadExcelService(serviceProvider.Object, _dbContext());
