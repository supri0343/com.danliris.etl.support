    ...
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services
                ...
                .AddTransient<Services.Interfaces.IPostBC33Service.IPostBeacukai33, Services.Class.PostBC33Service.PostBeacukaiService>()
                ...
                .AddTransient<Services.Interfaces.IPostBC25Service.IPostBeacukai25, Services.Class.PostBC25Service.PostBeacukaiService>()
                ...
                .AddTransient<Services.Interfaces.IPostBC33Service.IUploadExcel33, Services.Class.PostBC33Service.UploadExcelService>()
                ...
                .AddTransient<Services.Interfaces.IPostBC25Service.IUploadExcel25, Services.Class.PostBC25Service.UploadExcelService>();
        }
    }
}
